...
object Tree:
  ...
  final private case class Leaf(label: String, success: Boolean)         extends Tree
  final private case class Branch(label: String, children: Vector[Tree]) extends Tree
  final private case class Group(children: Vector[Tree])                 extends Tree
